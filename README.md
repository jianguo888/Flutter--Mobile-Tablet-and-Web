...
![image-20210928135718039](https://luckly007.oss-cn-beijing.aliyuncs.com/image/image-20210928135718039.png)
...
![image-20210928130530765](https://luckly007.oss-cn-beijing.aliyuncs.com/image/image-20210928130530765.png)
...
1. 运行 `dart pub upgrade --null-safety` 将依赖升级至支持空安全的最新版本。 **注意：** 该命令会更改你的 `pubspec.yaml` 文件。
   ...
   ![image-20210928130917128](https://luckly007.oss-cn-beijing.aliyuncs.com/image/image-20210928130917128.png)
...
![image-20210928131127465](https://luckly007.oss-cn-beijing.aliyuncs.com/image/image-20210928131127465.png)

![image-20210926165802333](https://luckly007.oss-cn-beijing.aliyuncs.com/image/image-20210926165802333.png)

![image-20210928131245421](https://luckly007.oss-cn-beijing.aliyuncs.com/image/image-20210928131245421.png)
